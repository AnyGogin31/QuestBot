...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("FREE", "BUSY", "WAITING_SCORE", name="actor_status"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("IDLE", "EN_ROUTE", "AT_ACTOR", "FINISHED", name="team_status"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "ASSIGNED", "IN_PROGRESS", "COMPLETED", "SKIPPED", name="stage_status"
            ),
            nullable=False,
        ),
